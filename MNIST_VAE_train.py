...
vae = VAE(784, [784, 800],[800, 800], z_dim, u, v, lamb)
for epoch in range(nepoch):
    vae.optimizer = tf.keras.optimizers.Adam(learning_rate=0.001*0.995**epoch)
    ...
    train_vae(vae, shuffled_inputs, batch_size)

#save model
# vae.save_weights(filepath ='trained_models/MNIST_'+str(z_dim)+'vae.h5')
...
#plt.savefig('test_img/vae_random_samples_'+str(z_dim)+'.png', dpi=500)
